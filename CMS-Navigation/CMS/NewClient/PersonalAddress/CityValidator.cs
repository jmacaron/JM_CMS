...
{
    class CityValidator : ValidationRule
    {
        ...
        public override ValidationResult Validate(object value, CultureInfo cultureInfo)
        {
            ...
            if (input.Length < MinSize)
                return new ValidationResult(false, $"City needs to be at least {MinSize} characters");
            if (input.Length > MaxSize)
                return new ValidationResult(false, $"City needs to be under {MaxSize} characters");
