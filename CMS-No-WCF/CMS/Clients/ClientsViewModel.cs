...
namespace CMS.Clients
{
    public class ClientsViewModel : BaseViewModel
    {
        ...
        public ClientsViewModel(IClientService clientService)
        {
            ...
            DelClients = new RelayCommand(DeleteClients);
        }
        ...
        public RelayCommand DelClients { get; set; }

        public void DeleteClients(object parameter)
        {
            MessageBox.Show("Into RemoveClients");
            //var newclients = _clients.Clone(x => x. == ClientID);
